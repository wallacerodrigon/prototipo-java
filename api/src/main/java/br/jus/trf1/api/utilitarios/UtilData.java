...
public class UtilData {
	...
	private static LocalDateTime getLocalDateTime(Date data) {
		...
		LocalDateTime hoje = LocalDateTime.of(calendar.get(Calendar.YEAR), calendar.get( Calendar.MONTH)+1, calendar.get( Calendar.DAY_OF_MONTH),
	...
	public static LocalDate getLocalDate(Date data) {
		...
		LocalDate hoje = LocalDate.of(calendar.get(Calendar.YEAR), calendar.get( Calendar.MONTH)+1, calendar.get( Calendar.DAY_OF_MONTH) );
		return hoje;
	}
	...
	public static LocalDateTime getLocalDateZeroHoras(Date data) {
		...
		LocalDateTime hoje = LocalDateTime.of(calendar.get(Calendar.YEAR), calendar.get( Calendar.MONTH)+1, calendar.get( Calendar.DAY_OF_MONTH), 0, 0 , 0);
		return hoje;
	}
	...
	public static Date getUltimaDataMes(Date dataBase) {
		LocalDate dataFimMes = getUltimaDataMes(getMes(dataBase), dataBase.getYear());
		return createData(dataFimMes.toEpochDay());
	}
